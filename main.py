...
async def start_handler(message: types.Message):
    ...
    welcome_text = (
        ...
        "Это устойчивый способ построения эмоциональных связей, сформированный в детстве "
    ...
    kb.add(InlineKeyboardButton("➡️ Начать диагностику", callback_data="start_test"))
